...
import {ModalFormDom} from '../forms';
import PropTypes from 'prop-types';

const ModalOrderDom = ({show, onShowToggle, postForm, id, formTitle, formSubtitle, submitText, hiddenInputInfo}) => {	
...
export default withFetchProductsService(mapMethodsToProps)(ModalOrderDom);